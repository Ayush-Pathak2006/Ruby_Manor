...
const Hero = () => {
  return (
    <div id="page1" className="h-screen w-full relative flex flex-col items-center justify-center text-center text-white p-4">
      <video autoPlay loop muted preload="metadata" poster="/Hero_img.png" src="/resturant-video.mp4" className="absolute top-0 left-0 h-full w-full object-cover z-0 brightness-[1.1]"></video>
